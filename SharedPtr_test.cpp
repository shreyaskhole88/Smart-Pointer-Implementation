...
void basic_tests_1() {
    ...
    // Test move copy constructor and move template copy constructor.
    {
        {
            SharedPtr<Derived> sp(new Derived);
            SharedPtr<Derived> sp2(std::move(sp));
        }
        {
            SharedPtr<Derived> sp(new Derived);
            SharedPtr<Base1> sp2(std::move(sp));
        }
    }
    ...
    // Test move assignment operator and move template assignment operator.
    {
        {
            SharedPtr<Derived> sp(new Derived);
            SharedPtr<Derived> sp2;
